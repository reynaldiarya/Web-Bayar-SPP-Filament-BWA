        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <img src="<?php echo e($user->scanijazah ? asset('storage/' . $user->scanijazah) : asset('images/default-ijazah.png')); ?>"
                        alt="Scan Ijazah" class="w-32 h-auto object-cover rounded-md border cursor-pointer"
                        x-on:click="$dispatch('open-modal', { id: 'image-modal', image: '<?php echo e($user->scanijazah ? asset('storage/' . $user->scanijazah) : asset('images/default-ijazah.png')); ?>' })">
                </div>
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\ASUS\Documents\Gung Cakra\PROJECT\LARAVEL\myspp\resources\views/filament/pages/biodata.blade.php ENDPATH**/ ?>